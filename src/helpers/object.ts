...
export function __flattenObj(obj: object | any, parent?: string, res: any | object = {}): object  {
    for (let key in obj) {
...
export function __unflattenObj(obj: object | any): object {
    let res: object | any = {}
    for (var i in obj) {
        let keys = i.split('.')
...
export function __mergeObj(target: any | object = {}, ...sources: object[] | any): object {
